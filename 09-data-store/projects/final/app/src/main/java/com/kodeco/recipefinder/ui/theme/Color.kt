...
val seed = Color(0xFF005893)


val transparent = Color(0x00FFFFFF);
val green = Color(0xff158442);
val lightGrey = Color(0xff5f6367);
val shim = Color(0x7f000000);
val lightGreen = Color(0xff42809E);
val lighterBlue = Color(0xff42809E);
val borderColor = Color(0xff9EE3FF);
val cardBackgroundColor = Color(0xfff8fdff);
val smallCardBackgroundColor = Color(0xffe3f6ff);
val darkBackgroundColor = Color(0xff21292E);
val iconBackgroundColor = Color(0xffABD5EC);
val background1Color = Color(0xff203c59);